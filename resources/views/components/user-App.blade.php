...
<head>
    ...
    <link rel="icon" href="img/ico/legalhelplogo.png" type="image/x-icon"/>
...
<body style="background-color: #e3e0cd">
  ...
  <!-- Side Menu -->
  <div id="sideMenu" class="fixed top-0 left-[-100%] w-64 h-full bg-[#1b5c60] text-white transition-all duration-300 transform z-[9999] p-4">
    <div class="profile-section flex flex-col items-center text-center border-b border-gray-700 pb-4 mb-4">
      <img src="https://via.placeholder.com/80" alt="Profile Picture" class="w-20 h-20 rounded-full border-2 border-gray-700 mb-2">
      @if (Auth::check())
    ...
    <nav class="mt-4">
      <a href="#" class="block py-2 px-4 hover:bg-gray-700 rounded">Profile</a>
      ...
      <a href="#" class="block py-2 px-4 hover:bg-gray-700 rounded"></a>
    </nav>
  </div>
